...
public class ThingStoreCQAdapter extends BaseAdapter {
    ArrayList<AbnormalProductBean> abnormalProductBeans;

    public ThingStoreCQAdapter(ArrayList<AbnormalProductBean> abnormalProductBeans) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.thing_store_cq_adapter, parent, false);
        }
