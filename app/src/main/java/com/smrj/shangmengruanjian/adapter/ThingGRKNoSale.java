...
public class ThingGRKNoSale extends BaseAdapter {
    ArrayList<AbnormalProductBean> abnormalProductBeans;

    public ThingGRKNoSale(ArrayList<AbnormalProductBean> abnormalProductBeans) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.thing_grknosale_adapter, parent, false);
        }
